...
- name: AWS Identity and Access Management API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/server/master/_listings/aws-identity-and-access-management/action-updateservercertificate-get.md
x-common:
- type: x-change-log
